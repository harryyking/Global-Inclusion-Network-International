  ...
  return (
    <header className="bg-base-100 shadow-sm sticky top-0 z-50">
      <div className="navbar container mx-auto max-w-6xl px-4">
        ...
        {/* Mobile Sheet */}
        <div className={`fixed inset-y-0 right-0 w-80 bg-base-100 shadow-xl transform transition-transform duration-300 ease-in-out lg:hidden ${isSheetOpen ? 'translate-x-0' : 'translate-x-full'}`}>
